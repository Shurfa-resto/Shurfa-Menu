  ...
  const MENU_DATA = [
    {
      ...
      items: [
        ...
        { en: 'Foul', ar: 'فول', price: 5.5 },
        { en: 'Fatteh', ar: 'فتّة', price: 6.0 },
        { en: 'Labneh', ar: 'لبنة', price: 5.0 },
        { en: 'Eggs', ar: 'بيض', price: 6.0 },
        { en: 'Vegetables', ar: 'خضار', price: 5.0 },
        { en: 'Olives', ar: 'زيتون', price: 2.0 },
        { en: 'Olives Salad', ar: 'سلطة زيتون', price: 5.0 },
        { en: 'Local Cheese', ar: 'جبنة بلدية', price: 6.0 },
      ],
    },
    {
      id: 'saj',
      ...
      titleAr: 'صاج',
      items: [
        { en: 'Zaatar', ar: 'زعتر', price: 1.5 },
        { en: 'Zaatar + Vegetables', ar: 'زعتر وخضار', price: 2.0 },
        { en: 'Cheese', ar: 'جبنة', price: 2.5 },
        { en: 'Cheese + Ham', ar: 'جبنة وجامبون', price: 3.5 },
        { en: 'Cheese + Sujuk', ar: 'جبنة وسجق', price: 4.0 },
        { en: 'Labneh + Vegetables', ar: 'لبنة وخضار', price: 2.0 },
        { en: 'Fajita', ar: 'فاهيتا', price: 7.0 },
        { en: 'Crispy', ar: 'كريسبي', price: 7.0 },
      ],
    },
    {
      id: 'mezza',
      ...
      subsections: [
        {
          ...
          items: [
            { en: 'Hummus', ar: 'حمص', price: 5.0 },
            { en: 'Hummus + Meat', ar: 'حمص باللحمة', price: 7.0 },
            { en: 'Mutabbal', ar: 'متبل', price: 5.0 },
            { en: 'Muhammara', ar: 'محمرة', price: 4.0 },
            { en: 'Labneh', ar: 'لبنة', price: 4.0 },
            { en: 'Labneh + Garlic', ar: 'لبنة بالثوم', price: 5.0 },
            { en: 'Warak Enab', ar: 'ورق عنب', price: 5.0 },
            { en: 'Shanklish', ar: 'شنكليش', price: 5.0 },
            { en: 'Chmandar', ar: 'شمندر', price: 4.0 },
            { en: 'Veggie Platter', ar: 'جاط خضرة', price: 5.0 },
          ],
        },
        {
          label: 'Hot Mezza',
          items: [
            ...
            { en: 'Batata Harra', ar: 'بطاطا حرة', price: 5.5 },
            { en: 'French Fries', ar: 'بطاطا مقلية', price: 5.0 },
            { en: 'Grilled Halloumi', ar: 'حلوم مشوي', price: 7.0 },
            { en: 'Halloumi + Zaatar', ar: 'حلوم بالزعتر', price: 7.0 },
            { en: 'Chicken Liver', ar: 'قصبة دجاج', price: 6.0 },
            { en: 'Naqaneq', ar: 'مقانق', price: 7.5 },
            { en: 'Soujouk', ar: 'سجق', price: 7.5 },
            { en: 'Cheese Rolls Fried', ar: 'رقاقات جبنة مقلية', price: 5.5 },
            { en: 'Cheese Rolls Grilled', ar: 'رقاقات جبنة مشوية', price: 5.5 },
            { en: 'Meat Sambousek', ar: 'سمبوسك لحمة', price: 6.0 },
            { en: 'Mixed Pastries', ar: 'معجنات مشكل', price: 15.0 },
            { en: 'Kibbeh', ar: 'قراص كبة', price: 7.0 },
            { en: 'Ras Asfour', ar: 'راس عصفور', price: 10.0 },
            { en: 'Mushroom + Meat', ar: 'فطر مع لحمة', price: 12.0 },
            { en: 'Grilled Wings', ar: 'أجنح  مشوية', price: 10.0 },
            { en: 'Fried Wings', ar: 'أجنحة مقلية', price: 10.0 },
          ],
        },
      ],
    },
    {
      ...
      titleAr: 'السلطات',
      items: [
        { en: 'Fattoush', ar: 'فتوش', price: 7.0 },
        { en: 'Tabbouleh', ar: 'تبولة', price: 7.0 },
        { en: 'Caesar Salad', ar: 'سيزار', price: 12.0 },
        { en: 'Monk Salad', ar: 'سلطة راهب', price: 5.0 },
      ],
    },
    {
      id: 'grills',
      ...
      titleAr: 'المشاوي',
      items: [
        { en: 'Taouk (4 Skewers)', ar: 'طاووق ٣ اسياخ', price: 12.0 },
        { en: 'Lamb Meat', ar: 'لحمة غنم', price: 16.0 },
        { en: 'Kebab (4 Skewers)', ar: 'كباب ٤ اسياخ', price: 15.0 },
        { en: 'Aleppo Kebab (4 Skewers)', ar: 'كباب حلبي ٤ اسياخ', price: 16.0 },
        { en: 'Arayes Kafta', ar: 'عرايس كفتة', price: 14.0 },
        { en: 'Mixed Grill Platter', ar: 'مشاوي مشكلة', price: 40.0 },
        { en: 'Spit-Roasted Chicken', ar: 'فروج مسحب', price: 20.0 },
        { en: '1/2 Chicken', ar: 'نصف فروج', price: 10.0 },
      ],
    },
    {
      id: 'raw-meat',
      ...
      items: [
        { en: 'Raw Kibbeh', ar: 'كبة نية', price: 12.0 },
        { en: 'Tebleh', ar: 'تابلية', price: 12.0 },
        { en: 'Raw Ftayleh', ar: 'فتيلة نية', price: 14.0 },
        { en: 'Raw Kafta', ar: 'كفتة نية', price: 12.0 },
        { en: 'Raw Suwdeh', ar: 'سودة نية', price: 12.0 },
      ],
    },
    {
      id: 'platters',
      ...
      items: [
        ...
        { en: 'Pasta Chicken Alfredo', ar: 'باستا دجاج ألفريدو', price: 15.0 },
      ],
    },
    {
      id: 'burgers',
      ...
      subsections: [
        {
          label: 'Burgers',
          items: [
            { en: 'Ham Burger ', ar: 'همبرغر ', price: 10.0 },
            { en: 'Chicken Burger ', ar: 'برغر دجاج', price: 11.0 },
          ],
        },
        {
          label: 'Sandwiches',
          items: [
            { en: 'Submarine', ar: 'سابمارين', price: 11.0 },
            { en: 'Crispy Chicken Sandwich', ar: 'سندويش كريسبي', price: 9.5 },
            { en: 'Fajitas Sandwich', ar: 'سندويش فاهيتا', price: 12.0 },
            { en: 'Philadelphia Sandwich', ar: 'سندويش فيلادلفيا', price: 10.0 },
            { en: 'Chicken Alfredo Sub', ar: 'ساب دجاج ألفريدو', price: 10.0 },
          ],
        },
      ],
    },
    {
      ...
      subsections: [
        ...
        },
        {
          label: 'Hookah',
          items: [
            { en: 'Lemon + Mint', ar: 'حامض ونعنع', price: 6.0 },
            { en: 'Double Apple', ar: 'تفاحتين', price: 6.0 },
          ],
        },
      ],
    },
